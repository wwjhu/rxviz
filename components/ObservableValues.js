...
export default class ObservableValues extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        ...
        const { values: currValues, allTooltips: currAllTooltips, scale: currScale } = this.props;
        const { values: nextValues, allTooltips: nextAllTooltips, scale: nextScale } = nextProps;
        ...
        return (
            <g>
                {values.map((valueObj, valueIndex) => {
                    ...
                    const addMouseHandlers = hasHoverTooltip(observableIndex, valueIndex, allTooltips);
