...
export default class Tooltip extends Component {
    ...
    renderBackground() {
        ...
        path.arcTo(rectWidth, rectHeight, rectWidth - cornerRadius, rectHeight, cornerRadius);
    ...
    render() {
        ...
        return (
            <g ref={this.storeContainerReference} style={style}>
                ...
                <TooltipText x={textPaddingLeft} y={textPaddingTop} text={text} textStyle={textStyle} />
            </g>
        );
    }
}
