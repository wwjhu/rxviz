...
export default class ObservableError extends Component {
    ...
    render() {
        ...
        const { height, mainColor, shapeOuterSize, scale, style, onMouseEnter, onMouseLeave } = this.props;
        ...
        return (
            <g style={style} ref={this.maybeCallOnRender}>
                <line x1={minX} y1={minY} x2={maxX} y2={maxY} strokeWidth={errorStrokeWidth} stroke={mainColor} />
                <line x1={minX} y1={maxY} x2={maxX} y2={minY} strokeWidth={errorStrokeWidth} stroke={mainColor} />
                {tooltip ? (
                    <rect
                        x={minX}
                        y={minY}
