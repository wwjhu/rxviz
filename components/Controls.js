...
const checkIcon = (
    <svg width="16" height="16" viewBox="0 0 24 24">
        <path fill="#eeeff0" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" />
    </svg>
);
...
export default class extends Component {
    ...
    renderTimeWindowInput() {
        const { timeWindow, onTimeWindowFocus, onTimeWindowChange, onTimeWindowBlur } = this.props;
    ...
    renderShareButton() {
        ...
        return (
            <Button
                ...
                icon={shareState === 'error' ? alertIcon : shareState === 'shared' ? checkIcon : shareIcon}
                text={shareState === 'error' ? 'Failed' : shareState === 'shared' ? 'Link copied' : 'Share link'}
    ...
    render() {
        ...
        return (
            <Measure bounds={true} onResize={this.onResize}>
                {({ measureRef }) => (
                    <div ref={measureRef} style={{ height: 60 /* To avoid a jump from SSR */ }}>
                        {width === null ? null : (
                            <div className="container">
                                <div className="inner-container">
                                    <form className="second-inner-container" onSubmit={this.onFormSubmit}>
