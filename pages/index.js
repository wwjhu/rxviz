...
export default class extends Component {
    ...
    onVisualize = () => {
        const { code, timeWindowInputValue, timeWindowInputValueBeforeChange, lastSnippetId } = this.state;
        const newTimeWindowInputValue =
            timeWindowInputValue === null ? timeWindowInputValueBeforeChange : timeWindowInputValue;
        const vizParams = {
