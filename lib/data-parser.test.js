...
import { defaultMainColor, defaultShapeColor, defaultObservableColor, colors } from './colors';
...
const expectToEqual = (calculatedModel, expectedModel) => {
    ...
    expect(sortBy(calculatedModel.connectors, 'time')).toEqual(expectedModel.connectors);
};
            ...
            values: [
                {
                    ...
                    values: [
                        {
                            time: 1000,
                            value: '1' /* When renderer exists, values are passed, not text. */,
                        },
                        {
                            time: 2000,
                            error: true,
